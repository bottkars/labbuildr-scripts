...
### Install 
	printf " ### Install Packages "
		if apt-get install rabbitmq-server -y >> /tmp/os_logs/rabbitmq.log 2>&1; then
			...
			printf $red " ERROR --> Could not install RabbitMQ Packages - see /tmp/os_logs/rabbitmq.log"
		fi			
