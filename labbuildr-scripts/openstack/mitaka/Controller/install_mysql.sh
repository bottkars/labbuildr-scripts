...
### Start MariaDB-Server
	...
	printf " ### Create SQL User and Permissions "	
		...
		mysql -u root --password='Password123!' -e "GRANT ALL PRIVILEGES ON nova_api.* TO 'nova'@'localhost' IDENTIFIED BY 'Password123\!';"
		mysql -u root --password='Password123!' -e "GRANT ALL PRIVILEGES ON nova_api.* TO 'nova'@'%' IDENTIFIED BY 'Password123\!';"
		#Neutron
