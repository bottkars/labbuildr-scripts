...
### Install
	printf " ### Install Packages "
		if apt-get install cinder-api cinder-scheduler cinder-volume python-cinderclient -y >> /tmp/os_logs/cinder.log 2>&1; then
			printf $green " --> done"
		else
			printf $red " ERROR --> Could not install Cinder Packages - see /tmp/os_logs/cinder.log"
		fi		
